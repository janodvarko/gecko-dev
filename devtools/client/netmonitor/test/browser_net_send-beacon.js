...
add_task(function* () {
  ...
  is(request.data.method, "POST", "The method is correct.");
  ok(request.data.url.endsWith("beacon_request"), "The URL is correct.");
  is(request.data.status, "404", "The status is correct.");
